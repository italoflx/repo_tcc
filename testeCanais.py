import cv2
import numpy as np
from utils import alargar_contraste, redimensionar_para_tela, passa_alta

imagem = cv2.imread('E:\\projetos\\imagensTcc\\MotoG10_Finais\\CamaraoVermelho3x1.jpg')
imagem2 = cv2.imread('E:\\projetos\\imagensTcc\\RedmiNote11S_Finais\\CamaraoPreto1x1.jpg')
